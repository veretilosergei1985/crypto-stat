...
use App\Service\DataProvider\CryptoBubblesDataProvider;
...
class CategoryController extends AbstractController
{
    ...
    public function __construct(EntityManagerInterface $entityManagerInterface, public readonly CryptoBubblesDataProvider $cryptoBubblesDataProvider)
    {
    ...
    {
        $this->cryptoBubblesDataProvider->getData();
        // Get category repository
        $categoryRepository = $this->entityManagerInterface->getRepository(Category::class);
